...
export default class Product extends Common {
  ...
  public ManyLagosRestaurantProducts: ProductPaginator | undefined;
  ...
  constructor() {
    ...
    this.defineReactiveProperty("ManyLagosRestaurantProducts", undefined);
    ...
    return $api.product
      ...
      .then((response) => {
        if (!isLoadMore) {
          ...
          const existingData: ProductPaginator = forBusiness
  ...
  public GetLagosRestaurantProducts = async (page: number, count: number) => {
    return $api.product
      .GetLagosRestaurantProducts(page, count)
      .then((response) => {
        this.ManyLagosRestaurantProducts =
          response.data?.LagosRestaurantProducts;
        return this.ManyLagosRestaurantProducts;
      });
  };
